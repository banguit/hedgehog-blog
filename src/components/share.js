...
hedgehog.Share.prototype.createDom = function() {
  ...
  var facebook = goog.dom.createDom('a',
      {'href': 'javascript:void(0)', 'class': 'facebook'},
      goog.dom.createDom('i', 'fa fa-facebook'));
  var googleplus = goog.dom.createDom('a',
      {'href': 'javascript:void(0)', 'class': 'googleplus'},
      goog.dom.createDom('i', 'fa fa-google-plus'));
  var twitter = goog.dom.createDom('a',
      {'href': 'javascript:void(0)', 'class': 'twitter'},
      goog.dom.createDom('i', 'fa fa-twitter'));

  goog.events.listen(facebook, goog.events.EventType.CLICK,
      this.facebookShareHandler_, false, this);
  goog.events.listen(googleplus, goog.events.EventType.CLICK,
      this.googleplusShareHandler_, false, this);
  goog.events.listen(twitter, goog.events.EventType.CLICK,
      this.twitterShareHandler_, false, this);
...
hedgehog.Share.prototype.enterDocument = function() {
  hedgehog.Share.base(this, 'enterDocument');
};
...
hedgehog.Share.prototype.facebookShareHandler_ = function() {
  var url = 'http://www.facebook.com/sharer.php?s=100&' +
      'app_id=354317658069297&display=popup';
